  ...
  return (
    <Canvas shadows camera={{ position: [-4.5, 0, 12], fov: 35 }}>
      <Suspense fallback={null}>
        ...
        <Ocean
          // options={(waterColor = new THREE.Color(0x2eff70))}
        ...
        <Coral color={""} url={coral3} scale={25} rotation={[0, 0, 0]} position={[-5, 4, -2]} />

        <Coral color={""} url={coral3} scale={30} rotation={[Math.PI / 6, Math.PI / 6, 0]} position={[60, 20, -2]} />

        <Coral color={""} url={coral3} scale={20} rotation={[-Math.PI / 3, Math.PI / 3, 0]} position={[30, 3, -40]} />
